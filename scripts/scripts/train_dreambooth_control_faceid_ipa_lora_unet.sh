...
export OUTPUT_DIR="./simplitex-trained-model-controlnet-faceid-ipa-loar-unet_3.26"
...
CUDA_VISIBLE_DEVICES=2 python train_dreambooth_control_faceid_ipa_lora_unet.py --pretrained_model_name_or_path=$MODEL_NAME  \
        --instance_data_dir=$INSTANCE_DIR   --output_dir=$OUTPUT_DIR --class_data_dir=$CLASS_DIR \
        --instance_prompt="a sks texturemap"  \
