...
export OUTPUT_DIR="./simplitex-trained-model-controlnet-faceid-ipa-noloar_3.26"
...
CUDA_VISIBLE_DEVICES=7 python train_dreambooth_control_faceid_ipa_nolora.py --pretrained_model_name_or_path=$MODEL_NAME  \
        --instance_data_dir=$INSTANCE_DIR   --output_dir=$OUTPUT_DIR --class_data_dir=$CLASS_DIR \
        --instance_prompt="a sks texturemap"  \
