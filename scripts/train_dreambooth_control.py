...
def main(args):
    ...
    params_to_optimize = (
        itertools.chain(unet.parameters(), text_encoder.parameters(), controlnet.parameters()) if args.train_text_encoder else unet.parameters()
    )
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                if accelerator.sync_gradients:
                    params_to_clip = (
                        itertools.chain(unet.parameters(), text_encoder.parameters(), controlnet.parameters())
                        if args.train_text_encoder
