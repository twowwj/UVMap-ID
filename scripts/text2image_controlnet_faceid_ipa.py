...
# path='/workspace/wwang/UVMap-ID/models/ip-adapter-faceid_sd15.bin'

# image_proj_model.load_state_dict(torch.load(path)['image_proj'])
...
def set_ip_adapter(unet, num_tokens=16, scale=0.5):
    ...
    state_dict = torch.load('/workspace/wwang/UVMap-ID/models/ip-adapter-faceid_sd15.bin', map_location="cpu")
...
if __name__ == "__main__":
    ...
    image_proj_model.load_state_dict(torch.load('/workspace/wwang/UVMap-ID/models/ip-adapter-faceid_sd15.bin')['image_proj'])
